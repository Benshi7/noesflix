...
export const tmdb = {
  ...
  apiKey: "?api_key=12c3bb92ea01829e9da98b1c7b40a36f",
  entity: {
...
export const tryGetPopularMovies = async (page = 1) => {
  try {
    const res = await axios(
      `https://api.themoviedb.org/3/movie/popular?api_key=12c3bb92ea01829e9da98b1c7b40a36f&language=en-US&page=${page}`
    );
